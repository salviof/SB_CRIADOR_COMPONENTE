...
import com.super_bits.Super_Bits.SB_CRIADOR_COMPONENTE.model.mapaComponentes.*;
...
public @interface InfoAcaoBeamExemploDemo {

    public boolean padraoBloqueado() default true;

    public FabAcaoBeanExemploDemonstrativo acao();
}
