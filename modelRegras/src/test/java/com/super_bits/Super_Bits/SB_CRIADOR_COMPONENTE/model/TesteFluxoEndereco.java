...
//            campoInstanciadoUF.getCampoInstanciadoRaiz().setLabel("Colé");
            ...
            List<EntidadeUnidadeFederativa> bairrosDisponiveis = (List) campoInstanciadoUF.getComoCampoLocalizacao().metodoAutoCompleteEstado("mg");
            campoInstanciadoUF.getComoCampoLocalizacao().setUnidadeFederativa((EntidadeUnidadeFederativa) bairrosDisponiveis.get(0));
            ...
            List<EntidadeCidade> cidadesDisponiveis = campoInstanciadoCidade.getComoCampoLocalizacao().metodoAutoCompleteCidade("Belo Hor");
