...
public class TesteComunicacao extends TestesWP_CRIADOR_COMPONENTES {
    ...
    public void testeComuinicacaoModal() {
        SBCore.getCentralComunicacao().
                gerarComunicacaoSistema_UsuairoLogado(FabTipoComunicacao.NOTIFICAR, "Teste", FabTipoTransporteComunicacao.INTRANET_MODAL);
        ...
        if (SBCore.getCentralComunicacao().aguardarRespostaComunicacao(FabTipoTransporteComunicacao.INTRANET_MODAL,
        ...
        SBCore.getCentralComunicacao().gerarComunicacaoSistema_UsuairoLogado(FabTipoComunicacao.NOTIFICAR, "Teste", FabTipoTransporteComunicacao.SMS, FabTipoTransporteComunicacao.INTRANET_MODAL);
        SBCore.getCentralComunicacao().gerarComunicacaoSistema_UsuairoLogado(FabTipoComunicacao.NOTIFICAR, "Teste", FabTipoTransporteComunicacao.SMS, FabTipoTransporteComunicacao.INTRANET_MODAL);
